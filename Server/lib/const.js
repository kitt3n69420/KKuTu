...
exports.ROBOT_IDLE2_MESSAGES = [ //봇이 게임 끝난 후 오랫동안 대기 중 보내는 메시지
	...
	"빨리빨리", "ㅁㄴㅇㄹ", "잠수 아니지?",  "빨리 고고", "잠수 쳐내",
	"ㄱㄱㄱㄱㄱㄱㄱㄱㄱㄱㄱㄱㄱ", "빨리 좀 해요", "ㄹㄷㄹㄷ", "님들 뭐함?",
	"강퇴하실", "ㅃㄹㅃㄹ", "어디감?", "이놈 잠수다"
];
...
exports.BOT_NAME_TEMPLATES = [
	"나일론머스크", "모레미파솔라시도", "벼량위의포효", "원조 끄투 봇", "끄투잘하고싶어요",
	...
	"가문의영광굴비", "나는난방고양이", "국립중앙방구석", "시베리안허숙희",
	"하츠네미꾸라지", "한강의기저귀", "레미콘아파트", 
	...
	"순데될라", "아침마담", "콩쥐들쥐", "태조샷건", "휴지필름", "벼락식혜", "빛과부",
];
