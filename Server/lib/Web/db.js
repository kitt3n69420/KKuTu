...
Pub.ready = function (isPub) {
	...
	function connectPg(noRedis) {
		...
		Pg.connect(function (err, testClient, release) {
			...
			DB.kkutu_mission_ko = new mainAgent.Table("kkutu_mission_ko");
			DB.kkutu_mission_en = new mainAgent.Table("kkutu_mission_en");
			DB.kkutu_mission_ja = new mainAgent.Table("kkutu_mission_ja");
			DB.kkutu_classic_ko = new mainAgent.Table("kkutu_classic_ko");
			DB.kkutu_classic_en = new mainAgent.Table("kkutu_classic_en");
